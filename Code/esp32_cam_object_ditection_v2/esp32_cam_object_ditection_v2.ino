...
// Return to project home position
Serial.println("Servo -> HOME (0 degrees)");
servoWriteAngle(SERVO_HOME_ANGLE);
delay(500);
...
void servoWriteAngle(int angle)
{
    ...
    // 16-bit LEDC = 65535 counts
    uint32_t duty =
        ((uint64_t)pulseWidth * 65535ULL) / 20000ULL;
